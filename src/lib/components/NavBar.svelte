<script lang="ts">
	...
	import ServerUrlModal from './ServerUrlModal.svelte';
...
<div class="relative z-10">
	<Navbar hidden={isReader}>
		...
		<div class="flex md:order-2 gap-5">
			...
			<CloudArrowUpOutline class="hover:text-primary-700" on:click={() => (serverModalOpen = true)} />
		</div>
	</Navbar>
</div>
...
<ServerUrlModal bind:open={serverModalOpen} />